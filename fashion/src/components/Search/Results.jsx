                    ...
                    <div className="col-lg-3 col-md-4 col-sm-6">
                        <article className="card card--1">
                            ...
                            <Link to={`/product/${data.itemid}`} className="card-link">
                                <div className="card__img--hover" style={{ backgroundImage: `url(${data.image_urls[0]})` }}></div>
                            </Link>
                            <div className="card__info">
                                <h3 className="card__title">{data.name}</h3>
                                <span className="card__category">{data.brand}</span>
                                <span className="card__by">trên <a href="#" className="card__author" title="author">{data.download_slot}</a></span>
